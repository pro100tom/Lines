...
namespace Lines
{
    static class ExtensionMethods
    {
        public static T FetchRandomItem<T>(this IList<T> collection)
        {
            lock (SyncLock)
            {
                var result = RandomObject.Next(0, collection.Count());
        ...
        public static Tuple<int, int> ToIndex2D(this int index)
        {
        ...
        public static int ToIndex1D(this Tuple<int, int> index2D)
        {
